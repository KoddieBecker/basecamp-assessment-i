...
// #4 Using the previously created variables, create a new variable called 'me' that uses the 
//myName and faveNum varible to create a sentence like this 'My name is Bryan and my favorite number is 3'
...
// *trueFaveNum* should equal true when comparing faveNum to your favorite number.v // HINT: Use a comparison operator

// CODE HERE
var trueFaveNum = 11 !== faveNum;

// #6 Create a new variable called notHakeem. Using the previously created myName variable, 
//test that your name DOES NOT equal the string 'Hakeem Olajuwon'. If your name does happen
// to be Hakeem Olajuwon, test against 'Karl Malone'

// CODE HERE
var notHakeem = "Hakeem Olajuwon" !== myName;

// #7 Create an if statement that checks the age variable below. If age is greater than 16,
// then set canDrive to true otherwise set canDrive to false. The canDrive variable will be 
//set by the unit test so do not adjust it.
var age = 18;
var canDrive;
...
//responseCreator responseCreator should assign the correct value to colorResponse
var colorResponse;
var responseCreator = function(param){
  // CODE HERE
  responseCreator =("What is your favorite color?");
  if(param =="green"){
...
responseCreator(colorResponse);

// #9 Create a function called 'sum' that takes in one parameter and returns the sum of that parameter 
//added it itself.
